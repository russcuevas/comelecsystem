        ...
        <div id="main" class="alt">
            ...
            <section id="one">
                <div class="inner">
                    ...
                    <p>Step 1. Go to the OEO where you are registered or intending to register.</p>
                    <p>Step 2. Get a CEF-1 form from the OEO. Blank forms are provided in all OEOs.</p>
                    <p>Step 3. Fill out all required fields for your application form using pen (Please write legibly).
                        Ask assistance from the
                        OEO if necessary.</p>
                    <p>Step 4. Submit your application to the OEO after writing all necessary information to the form.
                        Further instructions
                        shall be discussed to you by the OEO.</p>
                    <p>Step 5. Wait for the admin to put your submitted information in their system</p>
