...
<head>
    ...
    <div class="container mt-3">
        ...
        <div class="row voter-info">
            <div class="col-md-6">
                <img style="height: 100px; width: 100px; border-radius: 50px" src="../assets/dashboard/images/<?php echo $voter['profile_picture']; ?>" alt="">
        ...
        <p class="underline text-center">Registration Information</p>
